...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Label2.Location = New Point(44, 297)
        Label2.Name = "Label2"
        Label2.Size = New Size(156, 35)
        Label2.TabIndex = 1
        Label2.Text = "besar > kecil"
        ' 
        ' Label3
        ' 
        ...
        ' TextBox3
        ' 
        TextBox3.Location = New Point(251, 305)
        ...
        ' Button1
        ' 
        Button1.Location = New Point(568, 209)
        Button1.Name = "Button1"
        Button1.Size = New Size(123, 66)
        Button1.TabIndex = 6
        Button1.Text = "urutkan dari kecil ke besar"
        Button1.UseVisualStyleBackColor = True
        ' 
        ' Button2
        ' 
        Button2.Location = New Point(568, 378)
        Button2.Name = "Button2"
        Button2.Size = New Size(123, 68)
        Button2.TabIndex = 7
        Button2.Text = "urutkan dri besar ke kecil"
